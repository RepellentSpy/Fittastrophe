...
function showSleep() {
    ...
    document.getElementById("reader_article_content").style.animation = "fade_in 0.8s forwards";
    document.getElementById("reader_article_title").style.animation = "fade_in 0.8s forwards";
...
function arrow_forward_animate() {
    ...
    document.getElementById("reader_article_content").style.animation = "fade_out 0.8s forwards";
    document.getElementById("reader_article_title").style.animation = "fade_out 0.8s forwards";
    setTimeout(function () {
        window.location.href = "../subpages/coach.html";
    }, 290);
}